...
1.  The project templates from the [Python Tools 2.2 for Visual Studio Samples VSIX] are available under **Python**, **Samples**. Select **Polls Flask Web Project** and click OK to create the project.
...
5. Click the **Access Keys** part in the storage account's blade. Take note of the account name and the key1.
